...
food <- read.xlsx("../data/food_plan_180509.xlsx", 1, startRow = 2, endRow = 182, colIndex = c(3:7, 9:30), colClasses = c(rep("character", 6), rep("numeric", 20), "character"), stringsAsFactors = FALSE)
str(food)
