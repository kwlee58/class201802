...
total <- read.xlsx(file = "../data/DA_R_scoreList.xlsx", 
                   sheetIndex = 1, 
                   rowIndex = 1:36, 
                   colIndex = 2:8, 
...
total$Grades <- ifelse(total$Ranks <= floor(N * 0.35), 
                       "A+", 
                       ifelse(total$Total > 20, "B+", "F"))
o_names <- order(total$Name)
v_names_kr <- c("학번", "이름", "교실출석(20)", "중간고사(20)", "과제(40)", "팀 프로젝트(20)", "총점(100)", "순위(36명중)", "학점")
total_kr <- total
