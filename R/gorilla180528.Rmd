---
title: "Invisible Gorilla 201801"
author: "coop711"
date: "`r Sys.Date()`"
...
options(digits=3)
gorilla <- "../data/gorilla1801.xlsx" %>%
  read.xlsx(sheetIndex = 1, startRow = 2, endRow = 182, header = TRUE, 
            colIndex = c(3:7, 9:32), 
            colClasses = c(rep("character", 26), "numeric", rep("character", 2)),
