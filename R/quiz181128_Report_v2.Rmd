...
quiz1128 <- "../data/quiz181128.xlsx" %>% 
  read.xlsx(sheetIndex = 1, 
            ...
            colIndex = c(3:7, 9:14), colClasses = rep("character", 11),
            encoding = "UTF-8",
...
##1> 입력된 데이터 살피기
#> strsplit(quiz1128$Q1, ",") 하면 나오는 리스트의 요소를 month와 date 로 나웠다 다시 합치기
#> Q1의 생김새
quiz1128$Q1
#> pipe를 이용하여 고쳐쓰면
##> select를 이용할 때
...
`r knitr::include_graphics("../pics/matching_1996.png", dpi = NA)`
