...
assignment <- read.xlsx(file = "../data/assignment_v4.xlsx", 
                        sheetIndex = 1, 
                        rowIndex = 2:181, 
                        colIndex = c(3:4, 6:7), 
                        header = TRUE, 
...
total <- read.xlsx(file = "../data/scoreList_v4.xlsx", 
                   sheetIndex = 1, 
                   rowIndex = 3:182, 
                   colIndex = 2:8, 
...
total$Grades <- ifelse(total$Ranks <= floor((N - 2) * 0.3), 
                       "A+", 
                       ifelse(total$Ranks <= floor((N - 2) * 0.6), 
                              "B+", 
                              ifelse(total$Total > 0, 
                              "C+", "F")))
# total[total$Name %in% c("김범준"), "Grades"] <- "B+"
total[total$Name %in% c("신재성", "강동인"), "Grades"] <- "FA"
