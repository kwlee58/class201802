...
total <- read.xlsx(file = "../data/AR_01_scoreList_1802_v2.xlsx", 
                   sheetIndex = 1, 
                   rowIndex = 3:18, 
                   colIndex = 2:8, 
...
v.names.kr <- c("학번", "이름", "교실출석(20)", "중간고사(20)", "과제(40)", "팀 프로젝트(20)", "총점(100)", "순위(10명중)", "학점")
total.kr <- total
...
save.image(file = "../R/AR_records_01.RData")
```
