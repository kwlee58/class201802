...
quiz0523 <- "../data/quiz180523.xlsx" %>% 
  read.xlsx(sheetIndex = 1, 
            startRow = 2, endRow = 182, colIndex = c(3:7, 9:14), colClasses = rep("character", 12),
            stringsAsFactors = FALSE)
quiz0523 %>% str
names(quiz0523) <- c("dept", "id", "name", "year", "e.mail", "cell.no", "group", 
                     "Q1", "Q2", "Q3", "Q4")
quiz0523$dept %<>% factor
quiz0523$year %<>% factor
