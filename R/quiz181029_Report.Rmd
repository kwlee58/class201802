...
quiz1029 <- read.xlsx("../data/quiz181029.xlsx", 
                      sheetIndex = 1, 
                      startRow = 2, 
                      endRow = 155, 
                      colIndex = c(3:7, 9:14), 
...
quiz1029$dept <- factor(quiz1029$dept)
quiz1029$year <- factor(quiz1029$year)
quiz1029$group <- factor(quiz1029$group, 
                         levels = c("Red", "Black"))
quiz1029$Q1 <- factor(quiz1029$Q1, 
                      levels = c("가", "나", "다", "라", "무응답"), 
                      labels = c("랜덤화", "가짜약 대조군", "이중눈가림", "층화", "불참"))
quiz1029$Q2 <- factor(quiz1029$Q2, 
                      levels = c("가", "나", "다", "라"), 
                      labels = c("28 vs 46", "28 vs 71", "28 vs 25", "25 vs 54"))
quiz1029[c("Q3", "Q4", "group")]
quiz1029$Q3.2 <- quiz1029$Q3
Black <- quiz1029$group == "Black"
Red <- quiz1029$group == "Red"
#> 무응답은 오답으로 간주
quiz1029$Q3.2[Black] <- ifelse(quiz1029$Q3[Black] == "Beer,17", "Right", "Wrong")
quiz1029$Q3.2[Red] <- ifelse(quiz1029$Q3[Red] == "A,3", "Right", "Wrong")
# quiz1029$Q3.2[quiz1029$group == "Black" & quiz1029$Q3 == "Beer,17"] <- "Right"
# quiz1029$Q3.2[quiz1029$group == "Black" & quiz1029$Q3 != "Beer,17"] <- "Wrong"
# quiz1029$Q3.2[quiz1029$group == "Red" & quiz1029$Q3 == "A,3"] <- "Right"
# quiz1029$Q3.2[quiz1029$group == "Red" & quiz1029$Q3 != "A,3"] <- "Wrong"
quiz1029$Q3.2
quiz1029$Q4.2 <- quiz1029$Q4
quiz1029$Q4.2[Black] <- ifelse(quiz1029$Q4[Black] == "A,3", "Right", "Wrong")
quiz1029$Q4.2[Red] <- ifelse(quiz1029$Q4[Red] == "Beer,17", "Right", "Wrong")
# quiz1029$Q4.2[quiz1029$group == "Black" & quiz1029$Q4 == "A,3"] <- "Right"
# quiz1029$Q4.2[quiz1029$group == "Black" & quiz1029$Q4 != "A,3"] <- "Wrong"
# quiz1029$Q4.2[quiz1029$group == "Red" & quiz1029$Q4 == "Beer,17"] <- "Right"
# quiz1029$Q4.2[quiz1029$group == "Red" & quiz1029$Q4 != "Beer,17"] <- "Wrong"
quiz1029[c("Q3", "Q3.2", "Q4", "Q4.2", "group")]
str(quiz1029)
```
...
pander(tbl.q1.a)
pander(chisq.test(tbl.q1[, -c(4:5, 7)], 
...
tbl.q3.a <- addmargins(table(quiz1029$group, quiz1029$Q3.2, 
                             useNA = "ifany"))
...
tbl.q4.a <- addmargins(table(quiz1029$group, quiz1029$Q4.2, 
                             useNA = "ifany"))
