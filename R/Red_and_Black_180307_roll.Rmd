...
# str(class_roll)
load("./red_and_black_180307_data.RData")
```
...
pander(red.names[1:27, ], caption = "Red")
```

<P style="page-break-before:always">

```{r, red.names.2, echo = FALSE}
pander(red.names[28:54, ], caption = "Red")
```

<P style="page-break-before:always">

```{r, red.names.3, echo = FALSE}
pander(red.names[55:81, ], caption = "Red")
```

<P style="page-break-before:always">

```{r, red.names.4, echo = FALSE}
pander(red.names[82:nrow(red.names), ], caption = "Red")
```

<P style="page-break-before:always">

```{r, black.names, echo = FALSE}
pander(black.names[1:27, ], caption = "Black")
```

<P style="page-break-before:always">

```{r, black.names.2, echo = FALSE}
pander(black.names[28:54, ], caption = "Black")
```

<P style="page-break-before:always">

```{r, black.names.3, echo = FALSE}
pander(black.names[55:81, ], caption = "Black")
```

<P style="page-break-before:always">

```{r, black.names.4, echo = FALSE}
pander(black.names[82:nrow(black.names), ], caption = "Black")
```

<!--
```{r, save}
save.image("./red_and_black_180307_data.RData")
```
-->
