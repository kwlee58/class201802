---
title: "Food Habits Survey 180509"
author: "coop711"
date: "`r Sys.Date()`"
...
food <- read.xlsx("../data/food_survey_180509.xlsx", 1, startRow = 2, endRow = 182, colIndex = c(3:7, 9:30), colClasses = c(rep("character", 6), rep("numeric", 20), "character"), stringsAsFactors = FALSE)
str(food)
