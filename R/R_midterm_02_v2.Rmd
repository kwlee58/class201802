...
midterm.roll <- read.xlsx("../data/midterm_02_v2.xlsx", 
                          sheetIndex = 1, 
                          startRow = 3, 
                          endRow  = 31, 
                          colIndex = c(3:5, 10:49), 
                          colClasses = rep("character", 43), 
                          header = FALSE, 
                          encoding = "UTF-8",
                          stringsAsFactors = FALSE)
names(midterm.roll) <- c("dept", "id", "name", paste("Q", 1:40, sep = ""))
kable(head(midterm.roll[, 4:23]))
kable(head(midterm.roll[, 24:43]))
str(midterm.roll)
...
(ans <- scan("../data/midterm_ans_v2.txt", what = ""))
```
...
kable(data.frame("학과" = midterm.roll$dept, 
                 "학번" = midterm.roll$id, 
                 "이름" = midterm.roll$name,
                 "점수" = midterm.score))
```
