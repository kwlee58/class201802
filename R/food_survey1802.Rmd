---
title: "Food Habits Survey 181015"
author: "coop711"
date: "`r Sys.Date()`"
...
food <- read.xlsx("../data/food_survey_181015_recoding.xlsx", 
                  sheetIndex = 1, 
                  startRow = 2, endRow = 155, colIndex = c(3:7, 9:30), colClasses = c(rep("character", 6), rep("numeric", 20), "character"), stringsAsFactors = FALSE)
str(food)
...
```{r, echo = FALSE}
saveRDS(food, "./food_before1802.rds")
```
