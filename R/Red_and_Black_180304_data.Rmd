...
nrow(class_roll)
class_roll0901 <- read.xlsx("../data/class_roll0901.xlsx", 
                       sheetIndex = 1, 
                       startRow = 2, 
                        endRow = 181, 
                        colIndex = c(3:7, 9), 
...
names(class_roll0901) <- c("dept", "id", "name", "year", "e.mail", "cell.no")
class_roll0901$mark1 <- "0901"
class_roll0901$mark2 <- "0901"
class_roll$mark3 <- "0904"
class_roll.merged.0901 <- merge(class_roll0901, class_roll0901, 
                                by = "id", 
                                all = TRUE)
```
...
```{r, echo = FALSE}
class_roll.merged <- merge(class_roll.merged.0901, class_roll, 
                           by = "id",
                           all = TRUE)
...
stay0901 <- intersect(id0901, id0901)
length(stay0901)
...
stay == stay02
new_id <- setdiff(id0904, stay)
class_roll.stay <- subset(class_roll0901, id %in% stay)
...
save.image("../R/red_and_black_180904_data.RData")
```
-->