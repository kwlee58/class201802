...
total <- read.xlsx(file = "../data/CS_scoreList.xlsx", sheetIndex = 1, rowIndex = 3:19, colIndex = 2:8, colClasses = c(rep("character", 2), rep("numeric", 5)), header = TRUE)
...
v.names.kr <- c("학번", "이름", "교실출석(20)", "중간고사(20)", "과제(40)", "팀 프로젝트(20)", "총점(100)", "순위(16명중)", "학점")
total.kr <- total
