...
media_effects$group <- factor(media_effects$group, 
                              levels = c("Red", "Black"), 
                              labels = c("영문", "국문"))
str(media_effects)
```
...
media_effects.f[, c(1:2, 9:20)] <- lapply(media_effects.f[, c(1:2, 9:20)],
                                          function(x){factor(x, 
                                                             levels = c("가", "나", "다", "라"))})
media_effects.f[, 3:8] <- lapply(media_effects.f[, 3:8], 
                                 function(x){factor(x, 
                                                    levels = c("가", "나", "다", "라", "마"))})
# str(media_effects.f)
...
```{r}
save.image("media_effects_201801.RData")
```
-->