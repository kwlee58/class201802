...
quiz1115$Q3.2[Red] <- ifelse(quiz1115$Q3[Red] == "가", 
                             "실업률10%(취업률90%), 인플레12%", 
                             ifelse(quiz1115$Q3[Red] == "나", 
                                    "실업률5%(취업률95%), 인플레17%", 
                                    ifelse(quiz1115$Q3[Red] == "무응답", 
                                           "불참", "결석")))
quiz1115$Q3.2[Black] <- ifelse(quiz1115$Q3[Black] == "가", 
                               "실업률10%(취업률90%), 인플레12%", 
                               ifelse(quiz1115$Q3[Black] == "나", 
                                      "실업률5%(취업률95%), 인플레17%", 
                                      ifelse(quiz1115$Q3[Black] == "무응답",
                                             "불참", "결석")))
quiz1115$Q3.2 <- factor(quiz1115$Q3.2, 
                        levels = c("실업률10%(취업률90%), 인플레12%", 
                                   "실업률5%(취업률95%), 인플레17%",
                                   "불참"))
quiz1115$Q4.2[Red] <- ifelse(quiz1115$Q4[Red] == "가", "수용가능", 
                             ifelse(quiz1115$Q4[Red] == "나", "불공정", NA))
quiz1115$Q4.2[Black] <- ifelse(quiz1115$Q4[Black] == "가", "수용가능", 
                               ifelse(quiz1115$Q4[Black] == "나", "불공정", NA))
...
tbl.q3.p.a <- addmargins(round(prop.table(tbl.q3[1:2, -(3:4)], margin = 1)*100, 
                               digits = 1))[1:2, ]
