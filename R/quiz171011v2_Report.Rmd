...
##### 표시하지 않으면 장기 기증의사가 있는 것으로 간주하는 경우(Red)와 표시하면 장기 기증의사가 있는 것으로 간주하는 경우(Black), 표시하지 않으면 기증 의사가 있다고 보는 질문지에 기증 의사 비율이 더 높게 나오는 것으로 관찰되고는 있으나 통계적으로 유의한 정도는 아님. 어디다 디폴트를 두느냐에 따라 조사결과가 달라짐.
