...
quiz0416_2
quiz0416_2$dept %<>% factor
quiz0416_2$year %<>% factor
quiz0416_2$group %<>% factor(levels = c("Red", "Black"))
quiz0416_2$Q1 %<>% factor(levels = c("가", "나", "다", "라"), 
                          labels = c("평균:100, 중위값:200", 
                                     "평균:200, 중위값:100", 
                                     "평균:1,000, 중위값:100", 
                                     "평균:100, 중위값:1,000"))
quiz0416_2$Q2 %<>% factor(levels = c("가", "나", "다", "라"), 
                          labels = c("평균:100, 중위값:200", 
                                     "평균:200, 중위값:100", 
...
quiz0416_2$Q4 %<>% factor(level = c("O", "X"), 
                          labels = c("있음", "없음"))
quiz0416_2 %>% str
```

```{r, echo = FALSE, results = 'hide'}
quiz0416_2 %>% summary %>% pander
