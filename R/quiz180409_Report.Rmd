...
str(quiz0409)
names(quiz0409) <- c("dept", "id", "name", "year", "e.mail", "cell.no", "Q1", "Q2", "Q3", "Q4", "group")
quiz0409$dept <- factor(quiz0409$dept)
quiz0409$year <- factor(quiz0409$year)
