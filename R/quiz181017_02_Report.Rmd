...
quiz1017_02$Q4.2 <- quiz1017_02$Q4
levels(quiz1017_02$Q4.2[quiz1017_02$group == "Black"]) <- c("다", "나", "가", "라", "마", "무응답")
levels(quiz1017_02$Q4.2) <- c("지방선거와 동시에", "지방선거 이후 올해에", "내년이후", "기타", "모름/응답거절", "불참")
str(quiz1017_02)
```
...
levels(quiz1017_02$Q4.2)[levels(quiz1017_02$Q4.2) %in% c("모름/응답거절", "불참")] <- 
 "모름/응답거절"
tbl_q4_a <- quiz1017_02$Q4.2 %>%
  table(quiz1017_02$group, ., useNA = "ifany") %>%
  cbind(., "계" = rowSums(.)) %>%
  rbind(., "계" = colSums(.))
