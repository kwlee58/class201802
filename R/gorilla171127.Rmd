---
title: "Invisible Gorilla 201702"
author: "coop711"
date: "`r Sys.Date()`"
...
options(digits=3)
gorilla <- read.xlsx("../data/gorilla1702.xlsx", 1, startRow = 2, endRow = 182, header = TRUE, colIndex = c(3:7, 9:32), colClasses = c(rep("character", 26), "numeric", rep("character", 2)), stringsAsFactors = FALSE)
...
names(gorilla) <- c("dept", "id", "name", "year", "e.mail", "cell.no", "group", "Q1", "Q2.1", "Q2.2", "Q2.3", "Q3", "Q4.1", "Q4.2", "Q4.3", "Q4.4", "Q4.5", "Q4.6", "Q5.1", "Q5.2", "Q6.1", "Q6.2", "Q6.3", "Q6.4", "Q7", "Q8", "Q9.1", "Q9.2", "Q9.3")
